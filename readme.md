...
### 💖 收藏功能
- **一键收藏**：在充电桩详情页可快速收藏/取消收藏
- **收藏管理**：在个人中心查看和管理收藏的充电桩
- **状态记忆**：自动记忆充电桩的收藏状态
- **本地存储**：收藏数据保存在设备本地缓存中（**注意**：清除缓存后收藏数据会丢失）
...
1. **克隆项目**
   ...
   ```bash
   git clone https://github.com/philfan/zjuchargerWx.git
   ```
...
```bash
# 替换为你的 GitHub 仓库地址
git remote add origin https://github.com/yourusername/zjuchargerWx.git
```
